...
export default function NavbarContent(): JSX.Element {
  ...
  // Filter out sign in and sign up links from right items - we'll replace with UserMenu
  const filteredRightItems = rightItems.filter(
    (item: any) =>
      !item.to?.includes('/signin') &&
      !item.to?.includes('/signup') &&
      !item.className?.includes('navbar-signin') &&
